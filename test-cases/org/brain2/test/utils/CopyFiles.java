...
public class CopyFiles {
    ...
    public static void main(String[] args) {
        ...
        excludedDirList.add("lib");
        excludedDirList.add("bin");
        excludedDirList.add("build-results");
      ...
      //  excludedDirList.add("ci_db_cache");
        ...
        String src = "D:/yopco-ws";
        String des = "D:/Researchs/my-second-brain";
        try {
            log_content = new  StringBuilder();
            log_content.append("Build PHP from ").append(src).append(" to ").append(des).append("\n\n");
            CopyFiles.copyFiles(new File(src), new File(des));
